...
describe ProductGroupsController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ProductGroup" do
        expect {
          post :create, :product_group => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested product_group" do
        ...
        put :update, :id => product_group.id, :product_group => {'these' => 'params'}
      end

      it "assigns the requested product_group as @product_group" do
        product_group = ProductGroup.create! valid_attributes
        put :update, :id => product_group.id, :product_group => valid_attributes
        assigns(:product_group).should eq(product_group)
      end
    ...
    describe "with invalid params" do
      it "assigns the product_group as @product_group" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ProductGroup.any_instance.stub(:save).and_return(false)
        put :update, :id => product_group.id, :product_group => {}
        assigns(:product_group).should eq(product_group)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested product_group" do
      product_group = ProductGroup.create! valid_attributes
      expect {
        delete :destroy, :id => product_group.id
      }.to change(ProductGroup, :count).by(-1)
    end
